...
namespace Dissertation.Services
{
    public interface ILocationService
    {
        ...
        bool HaversineDistance(double lat1, double lon1, double lat2, double lon2, int distance);
    }
    ...
    public class LocationService : ILocationService
    {
        ...
        public bool HaversineDistance(double lat1, double lon1, double lat2, double lon2, int distance)
        {
